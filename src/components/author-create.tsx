                            ...
                            {(arrayProps) => (
                                ...
                                <div className="m-3">
                                    <button type="button" className="btn btn-info mb-2" onClick={() => arrayProps.push(new Book())}>
                                        ...
                                        <button type="button" className="btn btn-info mb-2" onClick={() => arrayProps.insert(0,new Book())}>
                                            Add First
                                        </button>
                                                ...
                                                <div className="card">
                                                    ...
                                                    <div className="card-body">
                                                        ...
                                                        <div className=" input-group flex-nowrap p-2">
                                                            ...
                                                            <span className="input-group-text text-info" > {formProps.values.books[index].edition} </span>
